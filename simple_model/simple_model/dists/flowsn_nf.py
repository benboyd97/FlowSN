...
class FlowSNP3D(Distribution):
    ...
    def __init__(self, m0, c0, x0, sigma_int, sigma_c, sigma_x, alpha, beta, alpha_c, W_mm, W_cc, W_xx, 
                 W_mc, W_mx, W_cx, m_cut, sigma_cut, a, b, flow_model, mu, std, log_det_std, *, validate_args=False):
        ...
        self.m0, self.c0, self.x0, self.sigma_int, self.sigma_c, self.sigma_x = m0, c0, x0, sigma_int, sigma_c, sigma_x
        ...
        self.m_cut, self.sigma_cut, self.a, self.b = m_cut, sigma_cut, a, b
    ...
    def log_prob(self, value):
        ...
        X = jnp.column_stack((
            ...
            jnp.log(self.sigma_int), jnp.log(self.sigma_c), jnp.log(self.sigma_x),
